...
/// <summary>Slice: soft-delete a task preserving its completions (RF-TASK-005).</summary>
public static class ArchiveHouseholdTask
{
    /// <summary>Command carrying the target id.</summary>
    public sealed record Command(Guid TaskId) : IRequest<Result<HouseholdTaskDto>>;

    /// <summary>Handler — flips IsArchived to true.</summary>
